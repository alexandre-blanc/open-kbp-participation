...
class EvaluateDose:
    ...
    def get_patient_dose_tensor(self, data_loader):
        ...
        print("avant : ", np.amax(dose_batch[dose_key][0]))
        dose_tensor = dose_batch[dose_key][0]*100  # Dose tensor # Multiplication by 100 because of rescaling
        print(" apres : ", np.amax(dose_tensor))
